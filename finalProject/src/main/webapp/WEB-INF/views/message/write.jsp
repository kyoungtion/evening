...
<div id="content">
    ...
    <form action=" " method="post" autocomplete="on">
        <p>
            <label for="username" class="icon-user"> 받는 사람
       ...
       <!--  <p>
        ...
        <p> -->
            <label for="subject" class="icon-bullhorn"> 제목
            	<span class="required">*</span>
            </label>
            <input type="text" name="subject" id="subject" required="required" placeholder="제목" />
        </p>
        ...
        <p>
            ...
            <textarea placeholder="내용" required="required"></textarea>
        </p>
        <p class="indication" style="float: right;">
            <span class="required"> * </span>필수 항목 입니다.</p>

        <input type="submit" value="보내기" style="text-align: center;" />
