...
<body>
	...
	<div class="evPage"style="height: auto; width: 100%; background: #ffffff; text-align: center;">
		<div class="pg"style="width: 65%; height: 1100px; display: inline-block; background: #f5f5f5;">
			<br>
			<div class="headLine" style="width: auto; display: inline-block;">
				...
				<br>
				<br>
				<p style="border-top: 1px solid gray;">${board.SG_ENROLL_DATE}<br> </p>
			</div>
						...
						<div class="colorlib-form" style="padding: 0em;">
							...
							<div style="width: 200px; height: 50px; float: left;">
								...
								<div style="width: 200px; height: 50px; float: left;">
									...
									<div class="sbViewAtag"><h3><i class="icon-heart2" id="clickTest" style="font-size: 18px;" ></i></h3><a id="likeCount">${ board.SG_LIKE }</a></div>
									<script>
